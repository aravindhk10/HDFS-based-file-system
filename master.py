  ...
  class exposed_Master():
    ...
    def alloc_blocks(self,dest,num):
      ...
      for i in range(0,num):
        ...
        # LOG.info(list(self.__class__.minions.keys()),self.__class__.replication_factor)
        nodes_ids = random.sample(list(self.__class__.minions.keys()),self.__class__.replication_factor)
